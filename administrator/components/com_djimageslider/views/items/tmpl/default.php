...
<form action="<?php echo JRoute::_('index.php?option=com_djimageslider'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td align="center">
					<?php if ($item->image) : ?>
						<a class="modal" href="../<?php echo $item->image; ?>"><img src="components/com_djimageslider/assets/icon-image.png" alt="<?php echo $this->escape($item->title); ?>" /></a>
					<?php endif; ?>
				</td>
				<td align="center">
					<?php echo $item->id; ?>
