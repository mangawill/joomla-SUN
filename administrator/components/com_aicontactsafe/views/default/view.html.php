...
class AiContactSafeViewDefault extends JView {
	...
	function __construct( $default = array() )	{
		...
		$this->help_url = 'http://www.jvitals.com/index.php?option=com_aimanual&lTag='.$lang->getTag().'&help_key=';
	...
	function setToolbar() {
		if ($this->_backend) {
			...
			JToolBarHelper::title( '<a href="' . JRoute::_('index.php?option=com_aicontactsafe', false) . '">' . '<span style="color:#003366;">ai</span><span style="color:#FEB01C;">ContactSafe</span>' . '</a><span id="ai_version" style="font-size:9px; margin-left:5px; color:#003366;">v.'.$this->_version.'</span>','generic_ai.png' );
		}
