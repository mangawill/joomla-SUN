			...
			if ($fileError > 0) {
		        ...
		        switch ($fileError) {
			        ...
			        case 7:
						...
						break;
			        case 8:
						$errorMessage = JText::_('COM_AICONTACTSAFE_A_PHP_EXTENSION_STOPPED_THE_FILE_UPLOAD_PHP_DOES_NOT_PROVIDE_A_WAY_TO_ASCERTAIN_WHICH_EXTENSION_CAUSED_THE_FILE_UPLOAD_TO_STOP;_EXAMINING_THE_LIST_OF_LOADED_EXTENSIONS_WITH_PHPINFO() may help.' );
						break;
				}
